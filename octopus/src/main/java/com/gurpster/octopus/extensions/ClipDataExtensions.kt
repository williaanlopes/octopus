...
inline val ClipData.items: Iterable<ClipData.Item>
    ...
    get() = object : Iterable<ClipData.Item> {
        override operator fun iterator(): Iterator<ClipData.Item> =
            object : Iterator<ClipData.Item> {
                private var index = 0
 ...
 */
@CheckResult
fun ClipboardManager.getPrimaryClipDataItem(): ClipData.Item? {
 ...
 */
@CheckResult
fun ClipboardManager.isPrimaryClipContentPlainText(): Boolean {
 ...
 */
@CheckResult
fun ClipboardManager.isPrimaryClipContentSensitive(): Boolean {
 ...
 */
fun ClipboardManager.clearPrimaryClipCompat() {
